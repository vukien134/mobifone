...
{
    public class CrudAssetToolDto : CruOrgBaseDto
    {
        ...
        public List<CrudAssetToolDetailDto> AssetToolDetails { get; set; }
        public List<CrudAssetToolStoppingDepreciationDto> AssetToolStoppingDepreciations { get; set; }
        public List<CrudAssetToolAccessoryDto> AssetToolAccessories { get; set; }
    }
}
