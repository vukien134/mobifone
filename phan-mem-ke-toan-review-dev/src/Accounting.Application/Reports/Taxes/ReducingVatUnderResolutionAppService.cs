...
{
    public class ReducingVatUnderResolutionAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public ReducingVatUnderResolutionAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.ReducingVatQH15ReportView)]
        public async Task<ReportResponseDto<ReducingVatDto>> CreateDataAsync(ReportRequestDto<TotalRevenueParameterDto> dto)
        {
            return await _reducingVatUnderResolutionBusiness.CreateDataAsync(dto);
        }
        [Authorize(ReportPermissions.ReducingVatQH15ReportPrint)]
        public async Task<FileContentResult> PrintAsync(ReportRequestDto<TotalRevenueParameterDto> dto)
        {
            var dataSource = await _reducingVatUnderResolutionBusiness.CreateDataAsync(dto);
