...
{
    public class ReducingVatAppService : AccountingAppService
    {
        #region Fields
        ...
        #region Ctor
        public ReducingVatAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.ReducingVatHkdReportView)]
        public async Task<ReportResponseDto<ReducingVatDto>> CreateDataAsync(ReportRequestDto<TotalRevenueParameterDto> dto)
        {
            return await _reducingVatBusiness.CreateDataAsync(dto);
        }
        [Authorize(ReportPermissions.ReducingVatHkdReportPrint)]
        public async Task<FileContentResult> PrintAsync(ReportRequestDto<TotalRevenueParameterDto> dto)
        {
            var dataSource = await _reducingVatBusiness.CreateDataAsync(dto);
