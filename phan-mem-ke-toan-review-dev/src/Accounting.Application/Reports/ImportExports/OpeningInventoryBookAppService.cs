...
{
    public class OpeningInventoryBookAppService : AccountingAppService
    {
        // Dùng chung dữ liệu với InventorySummaryBook
        #region Fields
        ...
        #endregion
        #region Ctor
        public OpeningInventoryBookAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.OpeningInventoryReportView)]
        public async Task<ReportResponseDto<InventorySummaryBookDto>> CreateDataAsync(ReportRequestDto<InventorySummaryBookParameterDto> dto)
        {
            ...
            var lstRankProduct = await _productGroupAppService.GetRankGroup("");
            ...
            var inventorySummaryBookData0 = (from a in iEInventoryData
                              ...
                              join c in lstRankProduct on b.ProductGroupId equals c.Id into bjc
        ...
        [Authorize(ReportPermissions.OpeningInventoryReportPrint)]
