...
{
    public class ListProductVoucherAppService : AccountingAppService
    {
        #region Privates
        ...
        #endregion
        #region Ctor
        public ListProductVoucherAppService(ProductVoucherService productVoucherService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.ListProductVoucherReportView)]
        public async Task<ReportResponseDto<ProductVoucherDto>> CreateDataAsync(ReportRequestDto<ReportBaseParameterDto> dto)
        {
            var queryable = await Filter(dto);
            var vouchers = await AsyncExecuter.ToListAsync(queryable);
            var dtos = vouchers.Select(p => ObjectMapper.Map<ProductVoucher, ProductVoucherDto>(p)).ToList();
            var reportResponse = new ReportResponseDto<ProductVoucherDto>();
        ...
        [Authorize(ReportPermissions.ListProductVoucherReportPrint)]
        ...
        #endregion
        #region Privates
        private async Task<IQueryable<ProductVoucher>> Filter(ReportRequestDto<ReportBaseParameterDto> dto)
        {
            var queryable = await _productVoucherService.GetQueryableAsync();
