...
{
    public class BusinessResultAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        public BusinessResultAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #region Methods
        [Authorize(ReportPermissions.BusinessResultReportView)]
        public async Task<ReportResponseDto<BusinessResultDto>> CreateDataAsync(ReportRequestDto<CashFlowBResultParameterDto> dto)
        {
            return await _businessResultBusiness.CreateDataAsync(dto);
        }
        [Authorize(ReportPermissions.BusinessResultReportPrint)]
        public async Task<FileContentResult> PrintAsync(ReportRequestDto<CashFlowBResultParameterDto> dto)
        {
            var dataSource = await _businessResultBusiness.CreateDataAsync(dto);
