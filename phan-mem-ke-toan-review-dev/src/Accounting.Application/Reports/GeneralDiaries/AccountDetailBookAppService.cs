...
{
    public class AccountDetailBookAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public AccountDetailBookAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.AccountDetailBookReportView)]
        ...
        [Authorize(ReportPermissions.AccountDetailBookReportPrint)]
