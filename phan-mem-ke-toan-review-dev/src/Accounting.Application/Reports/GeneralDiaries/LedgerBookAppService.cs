...
{
    public class LedgerBookAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public LedgerBookAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.LedgerBookReportView)]
        public async Task<ReportResponseDto<LedgerBookDto>> CreateDataAsync(ReportRequestDto<ReportBaseParameterDto> dto)
        {
            ...
            var lst = new List<LedgerBookDto>();
            ...
            var reportResponse = new ReportResponseDto<LedgerBookDto>();
        ...
        [Authorize(ReportPermissions.LedgerBookReportPrint)]
        ...
        #endregion
        #region Private
        private async Task<List<LedgerBookDto>> GetIncurredData(Dictionary<string,object> dic)
        {
