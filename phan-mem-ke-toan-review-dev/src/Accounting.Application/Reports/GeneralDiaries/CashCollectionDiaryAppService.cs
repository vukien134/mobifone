...
{
    public class CashCollectionDiaryAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public CashCollectionDiaryAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.CashCollectionDiaryReportView)]
        public async Task<ReportResponseDto<CashCollectionDiaryDto>> CreateDataAsync(ReportRequestDto<CashCollectionDiaryParameterDto> dto)
        {
            ...
            var acc1 = (dto.Parameters.Acc1 != "" && dto.Parameters.Acc1 != null) ? dto.Parameters.Acc1 : "112";
            var acc2 = (dto.Parameters.Acc2 != "" && dto.Parameters.Acc2 != null) ? dto.Parameters.Acc2 : "131";
            var acc3 = (dto.Parameters.Acc3 != "" && dto.Parameters.Acc3 != null) ? dto.Parameters.Acc3 : "138";
            var acc4 = (dto.Parameters.Acc4 != "" && dto.Parameters.Acc4 != null) ? dto.Parameters.Acc4 : "511";
        ...
        [Authorize(ReportPermissions.CashCollectionDiaryReportPrint)]
