...
{
    public class PurchaseDiaryAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public PurchaseDiaryAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.PurchaseDiaryReportView)]
        public async Task<ReportResponseDto<CashSpendDiaryDto>> CreateDataAsync(ReportRequestDto<CashCollectionDiaryParameterDto> dto)
        {
            ...
            var acc1 = (dto.Parameters.Acc1 != "" && dto.Parameters.Acc1 != null) ? dto.Parameters.Acc1 : "152";
            var acc2 = (dto.Parameters.Acc2 != "" && dto.Parameters.Acc2 != null) ? dto.Parameters.Acc2 : "153";
            var acc3 = (dto.Parameters.Acc3 != "" && dto.Parameters.Acc3 != null) ? dto.Parameters.Acc3 : "156";
            var acc4 = (dto.Parameters.Acc4 != "" && dto.Parameters.Acc4 != null) ? dto.Parameters.Acc4 : "157";
            var acc5 = (dto.Parameters.Acc5 != "" && dto.Parameters.Acc5 != null) ? dto.Parameters.Acc5 : "1331";
        ...
        [Authorize(ReportPermissions.PurchaseDiaryReportPrint)]
