...
{
    public class SellingDiaryAppService : AccountingAppService
    {
        #region Fields
        ...
        #endregion
        #region Ctor
        public SellingDiaryAppService(ReportDataService reportDataService,
                        WebHelper webHelper,
        ...
        #endregion
        #region Methods
        [Authorize(ReportPermissions.SellingDiaryReportView)]
        public async Task<ReportResponseDto<CashCollectionDiaryDto>> CreateDataAsync(ReportRequestDto<CashCollectionDiaryParameterDto> dto)
        {
            ...
            var acc1 = (dto.Parameters.Acc1 != "" && dto.Parameters.Acc1 != null) ? dto.Parameters.Acc1 : "5111";
            var acc2 = (dto.Parameters.Acc2 != "" && dto.Parameters.Acc2 != null) ? dto.Parameters.Acc2 : "5112";
            var acc3 = (dto.Parameters.Acc3 != "" && dto.Parameters.Acc3 != null) ? dto.Parameters.Acc3 : "5113";
            var acc4 = (dto.Parameters.Acc4 != "" && dto.Parameters.Acc4 != null) ? dto.Parameters.Acc4 : "5117";
            var acc5 = (dto.Parameters.Acc5 != "" && dto.Parameters.Acc5 != null) ? dto.Parameters.Acc5 : "3331";
            var lst = new List<CashCollectionDiaryDto>();
            var incurredAcc = "";
            ...
            decimal totalDebitIncurredCur = 0, 
                    ...
                    tTotalDebitIncurredCur = 0,
                    tTotalDebitIncurred = 0,
            ...
            var iQIncurredData = from a in incurredData
                                 select new CashCollectionDiaryDto
                                 {
                                     Sort = "A",
                                     Bold = "K",
                                     OrgCode = a.OrgCode,
                                     ...
                                     TotalDebitIncurredCur = a.DebitIncurredCur,
                                     TotalDebitIncurred = a.DebitIncurred,
                                     ReciprocalIncurredCur1 = (acc1 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc1)) ? a.DebitIncurredCur : null,
                                     ReciprocalIncurred1 = (acc1 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc1)) ? a.DebitIncurred : null,
                                     ReciprocalIncurredCur2 = (acc2 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc2)) ? a.DebitIncurredCur : null,
                                     ReciprocalIncurred2 = (acc2 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc2)) ? a.DebitIncurred : null,
                                     ReciprocalIncurredCur3 = (acc3 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc3)) ? a.DebitIncurredCur : null,
                                     ReciprocalIncurred3 = (acc3 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc3)) ? a.DebitIncurred : null,
                                     ReciprocalIncurredCur4 = (acc4 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc4)) ? a.DebitIncurredCur : null,
                                     ReciprocalIncurred4 = (acc4 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc4)) ? a.DebitIncurred : null,
                                     ReciprocalIncurredCur5 = (acc5 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc5)) ? a.DebitIncurredCur : null,
                                     ReciprocalIncurred5 = (acc5 != "" && (a.ReciprocalAcc ?? "").StartsWith(acc5)) ? a.DebitIncurred : null,
                                     ReciprocalAccOther = "",
            ...
            foreach (var item in incurredData)
            {
                ...
                item.ReciprocalIncurredCurOther = (item.ReciprocalIncurred1 == null && item.ReciprocalIncurred2 == null && item.ReciprocalIncurred3 == null && item.ReciprocalIncurred4 == null && item.ReciprocalIncurred5 == null) ? item.DebitIncurredCur : null;
                item.ReciprocalIncurredOther = (item.ReciprocalIncurred1 == null && item.ReciprocalIncurred2 == null && item.ReciprocalIncurred3 == null && item.ReciprocalIncurred4 == null && item.ReciprocalIncurred5 == null) ? item.DebitIncurred : null;
                ...
                tTotalDebitIncurredCur += item.TotalDebitIncurredCur ?? 0;
                tTotalDebitIncurred += item.TotalDebitIncurred ?? 0;
            ...
            lst.Add(new CashCollectionDiaryDto()
            {
                Sort = "B",
                Bold = "C",
                ...
                TotalDebitIncurredCur = tTotalDebitIncurredCur,
                TotalDebitIncurred = tTotalDebitIncurred,
            ...
            var reportResponse = new ReportResponseDto<CashCollectionDiaryDto>();
        ...
        [Authorize(ReportPermissions.SellingDiaryReportPrint)]
        ...
        #endregion
        #region Private
        private async Task<List<CashCollectionDiaryDto>> GetIncurredData(Dictionary<string,object> dic)
        {
            ...
            var incurredData = ledgerData.GroupBy(g => new
            {
                ...
                g.Representative,
                g.ReciprocalAcc
            }).Select(p => new CashCollectionDiaryDto()
            {
