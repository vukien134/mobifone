...
{
    public class AdjustDepreciationAppService : AccountingAppService, IAdjustDepreciationAppService
    {
        #region Field
        ...
        #endregion
        #region Ctor
        public AdjustDepreciationAppService(AdjustDepreciationService adjustDepreciationService,
        ...
        public async Task<List<DataAdjustDepreciationDetailDto>> GetDetailAsync(string adjustDepreciationId)
        {
            var adjustDepreciationDetails = await _adjustDepreciationDetailService.GetByAdjustDepreciationIdAsync(adjustDepreciationId);
        ...
        public async Task<List<DataAdjustDepreciationDetailDto>> GetAdjustDepreciationDetailAsync(string adjustDepreciationId)
        {
            var adjustDepreciationDetails = await _adjustDepreciationDetailService.GetByAdjustDepreciationIdAsync(adjustDepreciationId);
            var assetToolDetails = await _assetToolDetailService.GetQueryableAsync();
            assetToolDetails = assetToolDetails.Where(p => p.OrgCode == _webHelper.GetCurrentOrgUnit());
