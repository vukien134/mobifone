...
{
    public partial class MTenantStatement200 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TenantFStatement200L01",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L01", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L02",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L02", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L03",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L03", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L04",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L04", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L05",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L05", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L06",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L06", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L07",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L07", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L08",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L08", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L09",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L09", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L10",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L10", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L11",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L11", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L12",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L12", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L13",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L13", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L14",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L14", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L15",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L15", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L16",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L16", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L17",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L17", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L18",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L18", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TenantFStatement200L19",
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFStatement200L19", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L01_UsingDecision_Ord",
                table: "TenantFStatement200L01",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L02_UsingDecision_Ord",
                table: "TenantFStatement200L02",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L03_UsingDecision_Ord",
                table: "TenantFStatement200L03",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L04_UsingDecision_Ord",
                table: "TenantFStatement200L04",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L05_UsingDecision_Ord",
                table: "TenantFStatement200L05",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L06_UsingDecision_Ord",
                table: "TenantFStatement200L06",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L07_UsingDecision_Ord",
                table: "TenantFStatement200L07",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L08_UsingDecision_Ord",
                table: "TenantFStatement200L08",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L09_UsingDecision_Ord",
                table: "TenantFStatement200L09",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L10_UsingDecision_Ord",
                table: "TenantFStatement200L10",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L11_UsingDecision_Ord",
                table: "TenantFStatement200L11",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L12_UsingDecision_Ord",
                table: "TenantFStatement200L12",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L13_UsingDecision_Ord",
                table: "TenantFStatement200L13",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L14_UsingDecision_Ord",
                table: "TenantFStatement200L14",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L15_UsingDecision_Ord",
                table: "TenantFStatement200L15",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L16_UsingDecision_Ord",
                table: "TenantFStatement200L16",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L17_UsingDecision_Ord",
                table: "TenantFStatement200L17",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L18_UsingDecision_Ord",
                table: "TenantFStatement200L18",
                columns: new[] { "UsingDecision", "Ord" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantFStatement200L19_UsingDecision_Ord",
                table: "TenantFStatement200L19",
                columns: new[] { "UsingDecision", "Ord" });
        }
