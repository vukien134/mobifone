...
{
    public partial class AddAccCase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaseType = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccCase", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AccCase_OrgCode_Code",
                table: "AccCase",
                columns: new[] { "OrgCode", "Code" },
                unique: true)
                .Annotation("Npgsql:IndexInclude", new[] { "Name", "CaseType" });
        }
