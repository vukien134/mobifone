...
{
    public partial class DefaultStatementTax : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DefaultStatementTax",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultStatementTax", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DefaultStatementTax_Ord",
