...
{
    public class TenantDb : ITransientDependency
    {
        private readonly IDbContextProvider<TenancyDbContext> _dbContextProvider;
        public TenantDb(IDbContextProvider<TenancyDbContext> dbContextProvider)
        {
